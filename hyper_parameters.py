...
tf.app.flags.DEFINE_string('version', 'test_32', '''A version number defining the directory to save
...
tf.app.flags.DEFINE_string('ckpt_path', 'logs_test_32', '''Checkpoint
directory to restore''')
tf.app.flags.DEFINE_boolean('is_use_ckpt', True, '''Whether to load a checkpoint and continue
training''')

tf.app.flags.DEFINE_string('test_ckpt_path', 'logs_test_32', '''Checkpoint
directory to restore''')
